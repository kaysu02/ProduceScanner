/******/ (function (modules) {
    ...
    /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var _linearizeEncodings2 =
                _interopRequireDefault(_linearizeEncodings);
            ...
            var _getRenderProperties2 =
                _interopRequireDefault(_getRenderProperties);

            var _optionsFromStrings = __webpack_require__(41);

            var _optionsFromStrings2 =
                _interopRequireDefault(_optionsFromStrings);
            ...
            var JsBarcode = function JsBarcode(element, text, options) {
                ...
                api._renderProperties = (0, _getRenderProperties2.default)(
                    element,
                );
                api._encodings = [];
                        ...
                        function (text, options) {
                            ...
                            return api._errorHandler.wrapBarcodeCall(
                                function () {
                                    ...
                                    var newOptions = (0, _merge2.default)(
                                        api._options,
                                        options,
                                    );
                                    newOptions = (0,
                                    _optionsFromStrings2.default)(newOptions);
            ...
            function encode(text, Encoder, options) {
                ...
                if (!encoder.valid()) {
                    throw new _exceptions.InvalidInputException(
                        encoder.constructor.name,
                        text,
                    );
                }
                ...
                for (var i = 0; i < encoded.length; i++) {
                    encoded[i].options = (0, _merge2.default)(
                        options,
                        encoded[i].options,
                    );
                }
            ...
            API.prototype.init = function () {
                ...
                for (var i in this._renderProperties) {
                    ...
                    this._errorHandler.wrapBarcodeCall(function () {
                        ...
                        var Encoder =
                            _barcodes2.default[options.format.toUpperCase()];
            ...
            function render(renderProperties, encodings, options) {
                ...
                for (var i = 0; i < encodings.length; i++) {
                    encodings[i].options = (0, _merge2.default)(
                        options,
                        encodings[i].options,
                    );
            ...
            var CODE39 = (function (_Barcode) {
                ...
                function CODE39(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (
                            CODE39.__proto__ || Object.getPrototypeOf(CODE39)
                ...
                function CODE128AUTO(data, options) {
                    ...
                    if (/^[\x00-\x7F\xC8-\xD3]+$/.test(data)) {
                        var _this = _possibleConstructorReturn(
                            this,
                            (
                                CODE128AUTO.__proto__ ||
                                Object.getPrototypeOf(CODE128AUTO)
                            ).call(this, (0, _auto2.default)(data), options),
                        );
                    } else {
                        var _this = _possibleConstructorReturn(
                            this,
            ...
            var CODE128 = (function (_Barcode) {
                ...
                function CODE128(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (
                            CODE128.__proto__ || Object.getPrototypeOf(CODE128)
                        ).call(this, data.substring(1), options),
                    );
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function encode() {
                                ...
                                var startSet =
                                    _constants.SET_BY_CODE[startIndex];
                                ...
                                var encodingResult = CODE128.next(
                                    bytes,
                                    1,
                                    startSet,
                                );
                    ...
                    [
                        {
                            ...
                            value: function getBar(index) {
                                return _constants.BARS[index]
                                    ? _constants.BARS[index].toString()
                                    : '';
                            },
                                    ...
                                    // Continue on current set but encode a special character
                                        ...
                                        if (
                                            (set === _constants.SET_A ||
                                                set === _constants.SET_B) &&
                                            index === _constants.SHIFT
                                        ) {
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var SET_BY_CODE = (exports.SET_BY_CODE =
                ((_SET_BY_CODE = {}),
            ...
            var A_START_CHAR = (exports.A_START_CHAR =
                String.fromCharCode(208)); // START_A + 105
            var B_START_CHAR = (exports.B_START_CHAR =
                String.fromCharCode(209)); // START_B + 105
            var C_START_CHAR = (exports.C_START_CHAR =
                String.fromCharCode(210)); // START_C + 105
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var matchSetALength = function matchSetALength(string) {
                return string.match(
                    new RegExp('^' + _constants.A_CHARS + '*'),
                )[0].length;
            };
            var matchSetBLength = function matchSetBLength(string) {
                return string.match(
                    new RegExp('^' + _constants.B_CHARS + '*'),
                )[0].length;
            };
            var matchSetC = function matchSetC(string) {
                return string.match(
                    new RegExp('^' + _constants.C_CHARS + '*'),
                )[0];
            };
            ...
            exports.default = function (string) {
                ...
                if (cLength >= 2) {
                    newString =
                        _constants.C_START_CHAR + autoSelectFromC(string);
                } else {
                    // Select A/B depending on the longest match
                    var isA = matchSetALength(string) > matchSetBLength(string);
                    newString =
            ...
            var CODE128A = (function (_CODE) {
                ...
                function CODE128A(string, options) {
                    ...
                    return _possibleConstructorReturn(
                        ...
                        (
                            CODE128A.__proto__ ||
                            Object.getPrototypeOf(CODE128A)
                        ).call(this, _constants.A_START_CHAR + string, options),
                    );
                }
            ...
            var CODE128B = (function (_CODE) {
                ...
                function CODE128B(string, options) {
                    ...
                    return _possibleConstructorReturn(
                        ...
                        (
                            CODE128B.__proto__ ||
                            Object.getPrototypeOf(CODE128B)
                        ).call(this, _constants.B_START_CHAR + string, options),
                    );
                }
            ...
            var CODE128C = (function (_CODE) {
                ...
                function CODE128C(string, options) {
                    ...
                    return _possibleConstructorReturn(
                        ...
                        (
                            CODE128C.__proto__ ||
                            Object.getPrototypeOf(CODE128C)
                        ).call(this, _constants.C_START_CHAR + string, options),
                    );
                }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var EAN13 = (function (_EAN) {
                ...
                function EAN13(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (EAN13.__proto__ || Object.getPrototypeOf(EAN13)).call(
                            this,
                            data,
                            options,
                        ),
                ...
                _createClass(EAN13, [
                    ...
                    },
                    {
                        ...
                        value: function leftText() {
                            return _get(
                                EAN13.prototype.__proto__ ||
                                    Object.getPrototypeOf(EAN13.prototype),
                                'leftText',
                                this,
                            ).call(this, 1, 6);
                        },
                    },
                    {
                        ...
                        value: function leftEncode() {
                            ...
                            var structure =
                                _constants.EAN13_STRUCTURE[this.data[0]];
                            return _get(
                                EAN13.prototype.__proto__ ||
                                    Object.getPrototypeOf(EAN13.prototype),
                                'leftEncode',
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var EAN2_STRUCTURE = (exports.EAN2_STRUCTURE = [
                'LL',
                'LG',
                'GL',
                'GG',
            ...
            var EAN5_STRUCTURE = (exports.EAN5_STRUCTURE = [
                'GGLLL',
                'GLGLL',
                'GLLGL',
                'GLLLG',
            ...
            var EAN13_STRUCTURE = (exports.EAN13_STRUCTURE = [
                'LLLLLL',
                'LLGLGG',
                'LLGGLG',
                'LLGGGL',
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var EAN = (function (_Barcode) {
                ...
                function EAN(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (EAN.__proto__ || Object.getPrototypeOf(EAN)).call(
                            this,
                            data,
                            options,
                        ),
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var EAN8 = (function (_EAN) {
                ...
                function EAN8(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (EAN8.__proto__ || Object.getPrototypeOf(EAN8)).call(
                            this,
                            data,
                            options,
                        ),
                ...
                _createClass(EAN8, [
                    ...
                    },
                    {
                        ...
                        value: function leftText() {
                            return _get(
                                EAN8.prototype.__proto__ ||
                                    Object.getPrototypeOf(EAN8.prototype),
                                'leftText',
                                this,
                            ).call(this, 0, 4);
                        },
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var EAN5 = (function (_Barcode) {
                ...
                function EAN5(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (EAN5.__proto__ || Object.getPrototypeOf(EAN5)).call(
                            this,
                            data,
                            options,
                        ),
                ...
                _createClass(EAN5, [
                    ...
                    },
                    {
                        ...
                        value: function encode() {
                            var structure =
                                _constants.EAN5_STRUCTURE[checksum(this.data)];
                            return {
                                data:
                                    '1011' +
                                    (0, _encoder2.default)(
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var EAN2 = (function (_Barcode) {
                ...
                function EAN2(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (EAN2.__proto__ || Object.getPrototypeOf(EAN2)).call(
                            this,
                            data,
                            options,
                        ),
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var UPC = (function (_Barcode) {
                ...
                function UPC(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (UPC.__proto__ || Object.getPrototypeOf(UPC)).call(
                            this,
                            data,
                            options,
                        ),
                    ...
                    },
                    {
                        ...
                        value: function guardedEncoding() {
                            ...
                            result.push({
                                data:
                                    '101' +
                                    (0, _encoder2.default)(this.data[0], 'L'),
                                options: { height: this.guardHeight },
                            });

                            // Add the left side
                            result.push({
                                data: (0, _encoder2.default)(
                            ...
                            result.push({
                                data:
                                    (0, _encoder2.default)(this.data[11], 'R') +
                                    '101',
                                options: { height: this.guardHeight },
                            });
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var UPCE = (function (_Barcode) {
                ...
                function UPCE(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (UPCE.__proto__ || Object.getPrototypeOf(UPCE)).call(
                            this,
                            data,
                            options,
                        ),
                    ...
                    if (data.search(/^[0-9]{6}$/) !== -1) {
                        ...
                        _this.text =
                            ...
                            '' +
                                _this.upcA[0] +
                                data +
                                _this.upcA[_this.upcA.length - 1];
                        _this.isValid = true;
                ...
                _createClass(UPCE, [
                    ...
                    },
                    {
                        ...
                        value: function encodeMiddleDigits() {
                            ...
                            var parity =
                                PARITIES[parseInt(checkDigit)][
                                    parseInt(numberSystem)
                                ];
                            return (0, _encoder2.default)(
                                this.middleDigits,
                                parity,
                            );
                        },
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var ITF = (function (_Barcode) {
                ...
                function ITF() {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (ITF.__proto__ || Object.getPrototypeOf(ITF)).apply(
                            this,
                            arguments,
                        ),
                    );
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var ITF14 = (function (_ITF) {
                ...
                function ITF14(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (ITF14.__proto__ || Object.getPrototypeOf(ITF14)).call(
                            this,
                            data,
                            options,
                        ),
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var MSI = (function (_Barcode) {
                ...
                function MSI(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (MSI.__proto__ || Object.getPrototypeOf(MSI)).call(
                            this,
                            data,
                            options,
                        ),
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var MSI10 = (function (_MSI) {
                ...
                function MSI10(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (MSI10.__proto__ || Object.getPrototypeOf(MSI10)).call(
                            this,
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var MSI11 = (function (_MSI) {
                ...
                function MSI11(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (MSI11.__proto__ || Object.getPrototypeOf(MSI11)).call(
                            this,
            ...
            var MSI1010 = (function (_MSI) {
                ...
                function MSI1010(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (
                            MSI1010.__proto__ || Object.getPrototypeOf(MSI1010)
                        ).call(this, data, options),
                    );
                }
            ...
            var MSI1110 = (function (_MSI) {
                ...
                function MSI1110(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (
                            MSI1110.__proto__ || Object.getPrototypeOf(MSI1110)
                        ).call(this, data, options),
                    );
                }
            ...
            var pharmacode = (function (_Barcode) {
                ...
                function pharmacode(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (
                            pharmacode.__proto__ ||
                            Object.getPrototypeOf(pharmacode)
                        ).call(this, data, options),
                    );
            ...
            var codabar = (function (_Barcode) {
                ...
                function codabar(data, options) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (
                            codabar.__proto__ || Object.getPrototypeOf(codabar)
                        ).call(this, data.toUpperCase(), options),
                    );

                    _this.text =
                        _this.options.text || _this.text.replace(/[A-D]/g, '');
                    return _this;
                }
            ...
            var GenericBarcode = (function (_Barcode) {
                ...
                function GenericBarcode(data, options) {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (
                            GenericBarcode.__proto__ ||
                            Object.getPrototypeOf(GenericBarcode)
                        ).call(this, data, options),
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var _getOptionsFromElement2 = _interopRequireDefault(
                _getOptionsFromElement,
            );
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            function getOptionsFromElement(element) {
                ...
                for (var property in _defaults2.default) {
                    if (_defaults2.default.hasOwnProperty(property)) {
                        ...
                        if (
                            ...
                            options[property] = element.getAttribute(
                                'jsbarcode-' + property.toLowerCase(),
                            );
                        }
                ...
                options['value'] =
                    element.getAttribute('jsbarcode-value') ||
                ...
                _createClass(CanvasRenderer, [
                    ...
                    },
                    {
                        ...
                        value: function prepareCanvas() {
                            ...
                            (0, _shared.calculateEncodingAttributes)(
                                this.encodings,
                                this.options,
                                ctx,
                            );
                            var totalWidth = (0,
                            _shared.getTotalWidthOfEncodings)(this.encodings);
                            var maxHeight = (0,
                            _shared.getMaximumHeightOfEncodings)(
                                this.encodings,
                            );
                    ...
                    },
                    {
                        ...
                        value: function drawCanvasBarcode(options, encoding) {
                            ...
                            for (var b = 0; b < binary.length; b++) {
                                var x =
                                    b * options.width + encoding.barcodePadding;
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            exports.getTotalWidthOfEncodings =
                exports.calculateEncodingAttributes =
                exports.getBarcodePadding =
                exports.getEncodingHeight =
                exports.getMaximumHeightOfEncodings =
                    undefined;
            ...
            function calculateEncodingAttributes(
                ...
                for (var i = 0; i < encodings.length; i++) {
                    ...
                    encoding.width = Math.ceil(
                        Math.max(textWidth, barcodeWidth),
                    );
                ...
                _createClass(SVGRenderer, [
                    ...
                    },
                    {
                        ...
                        value: function drawSVGText(parent, options, encoding) {
                            var textElem = this.document.createElementNS(
                                svgns,
                                'text',
                            );
                            ...
                            if (options.displayValue) {
                                ...
                                textElem.appendChild(
                                    this.document.createTextNode(encoding.text),
                                );
                    ...
                    },
                    {
                        ...
                        value: function createGroup(x, y, parent) {
                            var group = this.document.createElementNS(
                                svgns,
                                'g',
                            );
                            group.setAttribute(
                    ...
                    },
                    {
                        ...
                        value: function drawRect(x, y, width, height, parent) {
                            var rect = this.document.createElementNS(
                                svgns,
                                'rect',
                            );
            ...
            var InvalidInputException = (function (_Error) {
                ...
                function InvalidInputException(symbology, input) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (
                            InvalidInputException.__proto__ ||
                            Object.getPrototypeOf(InvalidInputException)
                        ).call(this),
                    );
            ...
            var InvalidElementException = (function (_Error2) {
                ...
                function InvalidElementException() {
                    ...
                    var _this2 = _possibleConstructorReturn(
                        this,
                        (
                            InvalidElementException.__proto__ ||
                            Object.getPrototypeOf(InvalidElementException)
                        ).call(this),
                    );
            ...
            var NoElementException = (function (_Error3) {
                ...
                function NoElementException() {
                    ...
                    var _this3 = _possibleConstructorReturn(
                        this,
                        (
                            NoElementException.__proto__ ||
                            Object.getPrototypeOf(NoElementException)
                        ).call(this),
                    );
